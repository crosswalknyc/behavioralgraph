"""Re-export shim -> migration.super_fan_synthesis (TWIN_SYNC_SHIM_V1).
...
``from super_fan_synthesis import ...``), silently skipping newer logic.

The maintained implementation lives at ``migration/super_fan_synthesis.py``,
byte-synced from the parent repo's ``migration/super_fan_synthesis.py``.
...
import migration.super_fan_synthesis as _impl

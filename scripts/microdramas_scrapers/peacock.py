...
CURATED_BASELINE_TITLES = [
    # Hero rail (positions 1-2)
    {
        ...
        'series': 'The Billionaire\'s Secret Bride',
        'rank': 1,
        'surface': 'hero',
    ...
    {
        'title': 'Mafia Prince\'s Runaway Wife',
        'series': 'Mafia Prince\'s Runaway Wife',
        'rank': 2,
        'surface': 'hero',
    ...
    {
        'title': 'Married to My Alpha CEO',
        'series': 'Married to My Alpha CEO',
        'rank': 3,
        'surface': 'top_rail',
        'episodes': ['Ep 1', 'Ep 2', 'Ep 3', 'Ep 4'],
    },
    {
        'title': 'Stepbrother, You\'re Mine Now',
        'series': 'Stepbrother, You\'re Mine Now',
        'rank': 4,
        'surface': 'top_rail',
        'episodes': ['Ep 1', 'Ep 2', 'Ep 3'],
    },
    {
        'title': 'The Werewolf Boss Next Door',
        'series': 'The Werewolf Boss Next Door',
        'rank': 5,
        'surface': 'top_rail',
        'episodes': ['Ep 1', 'Ep 2', 'Ep 3', 'Ep 4', 'Ep 5'],
    },
    {
        'title': 'Revenge on the Ivy Elite',
        'series': 'Revenge on the Ivy Elite',
        'rank': 6,
        'surface': 'top_rail',
        'episodes': ['Ep 1', 'Ep 2'],
    },
    {
        'title': 'The Vampire\'s Contract Fiancee',
        'series': 'The Vampire\'s Contract Fiancee',
        'rank': 7,
        'surface': 'top_rail',
        'episodes': ['Ep 1', 'Ep 2', 'Ep 3'],
    },
    {
        'title': 'My Fake Marriage to a Real Mafia',
        'series': 'My Fake Marriage to a Real Mafia',
        'rank': 8,
        'surface': 'top_rail',
        'episodes': ['Ep 1', 'Ep 2'],
    },
    ...
    {
        'title': 'Rewriting My Sports-Star Ex',
        'series': 'Rewriting My Sports-Star Ex',
        'rank': 9, 'surface': 'mid_rail',
        'episodes': ['Ep 1', 'Ep 2', 'Ep 3'],
    },
    {
        'title': 'The Undercover Cop Wants Me',
        'series': 'The Undercover Cop Wants Me',
        'rank': 10, 'surface': 'mid_rail',
        'episodes': ['Ep 1', 'Ep 2'],
    },
    {
        'title': 'Secret Assassin, Doting Wife',
        'series': 'Secret Assassin, Doting Wife',
        'rank': 11, 'surface': 'mid_rail',
        'episodes': ['Ep 1'],
    },
    {
        'title': 'Sold to the Highest Bidder',
        'series': 'Sold to the Highest Bidder',
        'rank': 12, 'surface': 'mid_rail',
        'episodes': ['Ep 1', 'Ep 2'],
    },
    {
        'title': 'The Nanny\'s Billionaire',
        'series': 'The Nanny\'s Billionaire',
        'rank': 13, 'surface': 'mid_rail',
        'episodes': ['Ep 1', 'Ep 2', 'Ep 3', 'Ep 4'],
    },
    {
        'title': 'Dumped, Rich, and Ready for Payback',
        'series': 'Dumped, Rich, and Ready for Payback',
        'rank': 14, 'surface': 'mid_rail',
        'episodes': ['Ep 1', 'Ep 2'],
    },
    {
        'title': 'Trapped by the Vampire King',
        'series': 'Trapped by the Vampire King',
        'rank': 15, 'surface': 'mid_rail',
        'episodes': ['Ep 1'],
    },
    {
        'title': 'Bride of the Snow Mountain General',
        'series': 'Bride of the Snow Mountain General',
        'rank': 16, 'surface': 'mid_rail',
        'episodes': ['Ep 1', 'Ep 2'],
    },
    # Deep rail (positions 17+)
    {
        'title': 'The Bodyguard Who Loved Me',
        'series': 'The Bodyguard Who Loved Me',
        'rank': 17, 'surface': 'deep_rail',
        'episodes': ['Ep 1'],
    },
    {
        'title': 'CEO\'s Substitute Bride',
        'series': 'CEO\'s Substitute Bride',
        'rank': 18, 'surface': 'deep_rail',
        'episodes': ['Ep 1'],
    },
    {
        'title': 'The Return of the Divorced Wife',
        'series': 'The Return of the Divorced Wife',
        'rank': 19, 'surface': 'deep_rail',
        'episodes': ['Ep 1'],
    },
    {
        'title': 'Warrior Werewolves of the East Coast',
        'series': 'Warrior Werewolves of the East Coast',
        'rank': 20, 'surface': 'deep_rail',
        'episodes': ['Ep 1'],
    },
]

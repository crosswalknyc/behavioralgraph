"""Re-export shim -> migration.audience_cut_synthesis (TWIN_SYNC_SHIM_V1).
...
``from audience_cut_synthesis import ...``), silently skipping newer logic.

The maintained implementation lives at ``migration/audience_cut_synthesis.py``,
byte-synced from the parent repo's ``migration/audience_cut_synthesis.py``.
...
import migration.audience_cut_synthesis as _impl

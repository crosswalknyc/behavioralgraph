"""Shared password check for the WBD annual-value share page."""
import hashlib
import hmac

_SALT = b"crosswalk-wbd-gate-v1|"
_PASS_HASH = hashlib.sha256(_SALT + b"intersection").hexdigest()
COOKIE_NAME = "wbd_gate"

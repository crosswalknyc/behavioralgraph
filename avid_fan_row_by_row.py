"""Re-export shim -> migration.avid_fan_row_by_row (TWIN_SYNC_SHIM_V1).
...
``from avid_fan_row_by_row import ...``), silently skipping newer logic.

The maintained implementation lives at ``migration/avid_fan_row_by_row.py``,
byte-synced from the parent repo's ``migration/avid_fan_row_by_row.py``.
...
import migration.avid_fan_row_by_row as _impl

...
def run_query(conn, p):
    ...
    if 'TOTAL_SHOW_WATCHERS' in df_summary.columns and raw_total_watchers > 0:
        ...
        # Recalculate TOTAL_SHOW_CONVERSION_RATE based on boosted TOTAL_SHOW_WATCHERS
        if 'NEW_SIGNUPS' in df_summary.columns:
            ...
            if raw_new_signups > 0:
                ...
                # Recalculate conversion rate based on boosted values
    ...
    # Recalculate CLEAN_CONVERSION_RATE based on boosted values

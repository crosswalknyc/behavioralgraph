"""Re-export shim -> migration.dashboard_register (TWIN_SYNC_SHIM_V1).
...
``from dashboard_register import ...``), silently skipping newer logic.

The maintained implementation lives at ``migration/dashboard_register.py``,
byte-synced from the parent repo's ``migration/dashboard_register.py``.
...
import migration.dashboard_register as _impl
